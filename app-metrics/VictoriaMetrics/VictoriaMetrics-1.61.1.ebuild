...
EGO_SUM=(
	...
	"cloud.google.com/go v0.91.1/go.mod"
	...
	"github.com/VictoriaMetrics/fasthttp v1.0.16/go.mod"
	"github.com/VictoriaMetrics/metrics v1.12.2/go.mod"
	"github.com/VictoriaMetrics/metrics v1.17.3"
	"github.com/VictoriaMetrics/metrics v1.17.3/go.mod"
	"github.com/VictoriaMetrics/metricsql v0.18.0"
	"github.com/VictoriaMetrics/metricsql v0.18.0/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.38.68/go.mod"
	"github.com/aws/aws-sdk-go v1.40.22"
	"github.com/aws/aws-sdk-go v1.40.22/go.mod"
	"github.com/aws/aws-sdk-go-v2 v0.18.0/go.mod"
	"github.com/aws/aws-sdk-go-v2 v1.7.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.5.0/go.mod"
	"github.com/aws/smithy-go v1.5.0/go.mod"
	...
	"github.com/casbin/casbin/v2 v2.31.6/go.mod"
	...
	"github.com/go-kit/kit v0.11.0/go.mod"
	...
	"github.com/google/pprof v0.0.0-20210804190019-f964ff605595/go.mod"
	...
	"github.com/influxdata/flux v0.120.1/go.mod"
	...
	"github.com/influxdata/influxdb v1.9.3/go.mod"
	...
	"github.com/influxdata/influxdb1-client v0.0.0-20200827194710-b269163b24ab/go.mod"
	...
	"github.com/nats-io/jwt v1.2.2/go.mod"
	"github.com/nats-io/jwt/v2 v2.0.2/go.mod"
	"github.com/nats-io/nats-server/v2 v2.1.2/go.mod"
	"github.com/nats-io/nats-server/v2 v2.2.6/go.mod"
	"github.com/nats-io/nats.go v1.9.1/go.mod"
	"github.com/nats-io/nats.go v1.11.0/go.mod"
	...
	"github.com/streadway/handy v0.0.0-20200128134331-0f66f006fb2e/go.mod"
	...
	"github.com/valyala/gozstd v1.12.0/go.mod"
	"github.com/valyala/histogram v1.1.2"
	"github.com/valyala/histogram v1.1.2/go.mod"
	...
	"golang.org/x/oauth2 v0.0.0-20210810183815-faf39c7919d5/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20210811021853-ddbe55d93216/go.mod"
...
src_install() {
	...
	use vmalert && newbin bin/vmalert vmalert
}
