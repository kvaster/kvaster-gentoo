...
EGO_SUM=(
	...
	"cloud.google.com/go/storage v1.24.0/go.mod"
	...
	"github.com/Azure/go-autorest/autorest v0.11.11/go.mod"
	...
	"github.com/VictoriaMetrics/fastcache v1.10.0/go.mod"
	"github.com/VictoriaMetrics/fasthttp v1.1.0"
	"github.com/VictoriaMetrics/fasthttp v1.1.0/go.mod"
	"github.com/VictoriaMetrics/metrics v1.18.1/go.mod"
	"github.com/VictoriaMetrics/metrics v1.22.1"
	"github.com/VictoriaMetrics/metrics v1.22.1/go.mod"
	"github.com/VictoriaMetrics/metricsql v0.44.1"
	"github.com/VictoriaMetrics/metricsql v0.44.1/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.35.31/go.mod"
	"github.com/aws/aws-sdk-go v1.44.70"
	"github.com/aws/aws-sdk-go v1.44.70/go.mod"
	...
	"github.com/dmitryk-dk/pb/v3 v3.0.9/go.mod"
	...
	"github.com/go-openapi/analysis v0.19.14/go.mod"
	...
	"github.com/go-openapi/validate v0.19.14/go.mod"
	...
	"github.com/google/pprof v0.0.0-20201117184057-ae444373da19/go.mod"
	...
	"github.com/gophercloud/gophercloud v0.14.0/go.mod"
	...
	"github.com/influxdata/influxdb v1.10.0/go.mod"
	...
	"github.com/prometheus/prometheus v1.8.2-0.20201119142752-3ad25a6dc3d9/go.mod"
	...
	"github.com/valyala/gozstd v1.17.0/go.mod"
	...
	"golang.org/x/net v0.0.0-20220805013720-a33c5aa5df48/go.mod"
	...
	"golang.org/x/sys v0.0.0-20220405052023-b1e9470b6e64/go.mod"
	...
	"golang.org/x/sys v0.0.0-20220804214406-8e32c043e418/go.mod"
	...
	"golang.org/x/tools v0.0.0-20201119054027-25dc3e1ccc3c/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20220805133916-01dd62135a58/go.mod"
