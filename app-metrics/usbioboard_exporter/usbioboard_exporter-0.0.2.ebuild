...
EGO_SUM=(
	...
	"github.com/zserge/hid v0.0.0-20190124175232-e1626f1782f3/go.mod"
...
src_install() {
	newbin usbioboard_exporter usbioboard_exporter

	newinitd "${FILESDIR}"/usbioboard_exporter.initd usbioboard_exporter
	newconfd "${FILESDIR}"/usbioboard_exporter.confd usbioboard_exporter

	insinto /etc/usbioboard_exporter
