...
DESCRIPTION="Kres-netlinkd is a companion service for knot-resolver's blocked module"
...
EGO_SUM=(
	...
	"github.com/google/nftables v0.3.0/go.mod"
...
DEPEND="acct-user/knot-resolver"
RDEPEND="${DEPEND}"
...
src_install() {
	newbin kres-netlinkd kres-netlinkd

	newinitd "${FILESDIR}"/${PN}.initd ${PN}
	newconfd "${FILESDIR}"/${PN}.confd ${PN}

	insinto /etc/knot-resolver/kres_modules
	doins blocked.lua
}

pkg_postinst() {
	fcaps cap_net_admin=+ep usr/bin/kres-netlinkd
}
